package com.zhvavyy.scheduler.integration.kafka;
...
public class UserReportProducerIT extends BaseIntegrationTest {
    ...
    @Autowired
    private UserReportProducer userReportProducer;
    ...
    void testSendMessage_WithKafkaTemplate() throws ExecutionException, InterruptedException, TimeoutException {
        MessageForEmail message =
                new MessageForEmail(TEST_EMAIL, "test", "test");
